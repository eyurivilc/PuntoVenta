            ...
            <div class="box-body">
                <table class="table table-bordered dt-responsive table-striped tablas">
					...
					<?php
                        ...
                        $productos = ControllerProductos::crtMostrarProductos($item, $valor);
                        ...
                        foreach ($productos as $key => $value) {
                            echo '
								<tr>
									<td>'.($key+1).'</td>
									<td>
										<img src="views/img/products/default/anonymous.png" class="img-thumbnail" width="40px" alt="Imagen de producto">
									</td>
									<td>'.$value["codigo"].'</td>
            ...
            <form role="form" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <div class="box-body">
                        ...
                        <!--Entrada para la seleccionar Categoría-->
                        <div class="form-group">
                            <div class="input-group">
                        ...
                        <div class="form-group">
							...
							<img src="views/img/products/default/anonymous.png" class="img-thumbnail" width="100px" alt="Foto del producto">
                        </div>
                    </div>
                </div>
