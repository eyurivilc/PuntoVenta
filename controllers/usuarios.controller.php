				...
				preg_match('/^[a-zA-Z0-9]+$/', $_POST["ingPassword"])) {
					...
					if ($respuesta["usuario"] == $_POST["ingUsuario"] && $respuesta["password"] == $encriptar) {
					    ...
					    if ($respuesta["estado"] == 1) {
                            ...
                            /* REGISTRAR LA FECHA PARA SABER EL ÚLTIMO LOGIN */
                            ...
                            $ultimoLogin = ModelsUsuarios::mdlActualizarUsuario($tabla, $item1, $valor1, $item2, $valor2);
    ...
    static public function crtEditarUsuario() {
        ...
        if (isset($_POST["editarUsuario"])) {
            if (preg_match('/^[a-zA-Z0-9ñÑáéíóúÁÉÍÓÚ ]+$/', $_POST["editarNombre"])) {
                ...
                if ($_POST["editarPassword"] != "") {
                    if (preg_match('/^[a-zA-Z0-9]+$/', $_POST["editarPassword"])) {
                        ...
                        echo '<script>
                            swal({
                                type: "error",
                                title: "¡La constraseña no puede ir vacía o llevar caracteres especiales!",
                                showConfirmButton: true,
                                confirmButtonText: "Cerrar"                        
                            }).then((resultado) => {
                                if (resultado.value){
                ...
                $respuesta = ModelsUsuarios::mdlEditarUsuario($tabla, $datos);
